 ...
 * Programmer: Reanne Escota
 * Ma. Patricia Felicidario
 ...
 ********************�********************�********************�******/
 ...
 String binaryString=JOption�Pane.showInputDialog�("Enter a 6-bit binary number");

 // Convert from String to integer type
 int binary=Integer.parse�Int(binaryString);
 ...
 String decimalOutput="Decim�al: " + decimal;

 // Output message
 JOptionPane.showMess�ageDialog(null, binaryOutput + "\n" + decimalOutput,
 "Binary to Decimal Conversion", JOptionPane.INFORMAT�ION_MESSAGE);
